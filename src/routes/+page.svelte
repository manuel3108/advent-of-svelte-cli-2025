	...
	<div class="frame-9-16">
		<Presentation>
			...
			<Slide class="slide">
				...
				<div class="content">
					<svg class="svelte-logo-large" viewBox="0 0 98.1 118" width="80" height="96">
						<path fill="#ff3e00" d="M91.8 15.6C80.9-.1 59.2-4.7 43.6 5.2L16.1 22.8C8.6 27.5 3.4 35.2 1.9 43.9c-1.3 7.3-.2 14.8 3.3 21.3-2.4 3.6-4 7.6-4.7 11.8-1.6 8.9.5 18.1 5.7 25.4 11 15.7 32.6 20.3 48.2 10.4l27.5-17.5c7.5-4.7 12.7-12.4 14.2-21.1 1.3-7.3.2-14.8-3.3-21.3 2.4-3.6 4-7.6 4.7-11.8 1.7-9-.4-18.2-5.7-25.5"/>
			...
			<Slide class="slide">
				...
				<div class="content">
					...
					<StickyNotes 
						flags={['tailwindcss', 'playwright', 'storybook', 'lucia']} 
						variant="packages"
					/>
				</div>
			</Slide>
...
<style>
	...
	.main-title {
		font-size: 2rem;
		font-weight: 800;
		background: linear-gradient(135deg, #ff3e00 0%, #ff6b35 50%, #f7931a 100%);
